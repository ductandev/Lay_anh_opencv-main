...
class PandasModel(QAbstractTableModel):
    ...
    def setModified(self):
        ...
        print("hello setModified " + str(self.setChanged))
...
class Viewer(QMainWindow):
    ...
    def showSelection(self, item):
        ...
        # if str(cos) == "5":
        #     self.videos = Ui_add_image_2()
        #     self.videos.setupUi(self.lb)
    ...
    def loadRecent(self):
        if self.lastFiles.currentIndex() > 0:
            print("LoadRecents "+str(self.lastFiles.currentText()))
            print(self.model.setChanged)
            if  self.model.setChanged == True:
                print("is changed, saving?")
                quit_msg = "<b>The document was changed.<br>Do you want to save the changes?</ b>"
    ...
    def writeCSV(self):
        ...
        if fileName:
            ...
            dataFrame.to_csv(f, sep=',', index = True, header = True, encoding='utf-8')
